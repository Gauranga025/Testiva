...
function TestCaseList({ testCases, onReload, targetDomain, repository }: Props) {
    ...
    return (
        <div className='mt-6'>
            ...
            <TestExecutionModal
                ...
                repository={{
                    targetDomain: targetDomain || repository.targetDomain,
                    fullName: repository.fullName,
                }}
                onExecutionComplete={() => onReload(testCases[0]?.repoId)}
            />
        ...
        font-medium shadow-sm'
                            ...
                            {testCase?.status === 'generated' && (
                                <Badge className='rounded-full px-3 py-1 bg-gray-50 text-gray-600 border border-gray-200 font-medium shadow-sm'>
                                    Ready
                                </Badge>
                            )}
                ...
                <div className='px-6 py-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-linear-to-r from-gray-50 to-gray-100 border-t border-gray-200'>
                    <div>
                        ...
                        <p className='text-sm text-gray-500 mt-1'>
                            Open the execution modal for live logs, Browserbase session links, and recordings.
                        </p>
                    </div>
